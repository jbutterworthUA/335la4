	...
	private class ButtonClickListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (command.equals("search")) {
				...
				outputArea.setText("");
				String searchMethod = JOptionPane.showInputDialog(GUIView.this,
						"How would you like to search for the book? (title, author, rate)");
				// If user did not enter a valid search method, continue prompting until they do
				// so.
				while (!validMethods.contains(searchMethod)) {
					searchMethod = JOptionPane.showInputDialog(GUIView.this,
							"How would you like to search for the book? (title, author, rate)");
					searchMethod = searchMethod.toLowerCase();
				}
				if (searchMethod.equals("title")) {
					String keyword = JOptionPane.showInputDialog(GUIView.this,
							"Enter the " + searchMethod + " of the book you are looking for.");
					...
					instructionLabel.setText("Showing search results for title: " + keyword);
				}
				if (searchMethod.equals("author")) {
					...
					instructionLabel.setText("Showing search results for author: " + keyword);
				}
				if (searchMethod.equals("rate")) {
					String rateWord = JOptionPane.showInputDialog(GUIView.this,
							"Enter the " + searchMethod + " of the book you are looking for. (1 - 5)");
					int rate = Integer.parseInt(rateWord);
					while (rate < 1 || rate > 5) {
						rateWord = JOptionPane.showInputDialog(GUIView.this,
								"Enter the " + searchMethod + " of the book you are looking for. (1 - 5)");
					...
					instructionLabel.setText("Showing search results for rating: " + rate);
				}
				...
				boolean added = model.addBook(title, author);
				if (added) {
					instructionLabel.setText(title + " by " + author + " has been added to your library.");
				} else {
					instructionLabel.setText(title + " by " + author + " already in library.");
				}

			} else if (command.equals("set")) {
				outputArea.setText("");
				String title = JOptionPane.showInputDialog(GUIView.this,
				...
				outputArea.setText("");
				String title = JOptionPane.showInputDialog(GUIView.this,
						"Enter the title of the book you would like to rate: ");
				String author = JOptionPane.showInputDialog(GUIView.this,
						"Enter the author of the book you would like to rate: ");
				...
				boolean found = model.rate(title, author, newRate);
				if (found) {
					instructionLabel.setText("The rate for " + title + " by " + author + " has been updated.");
				} else {
					instructionLabel.setText(title + " by " + author + " not found.");
				}

			} else if (command.equals("get")) {
				outputArea.setText("");
				ArrayList<String> validMethods = getSortMethods();
				String sortMethod = JOptionPane.showInputDialog(GUIView.this,
						"How would you like your books sorted? (title, author, read, unread)");
				while (!validMethods.contains(sortMethod)) {
					sortMethod = JOptionPane.showInputDialog(GUIView.this,
							"Please enter a valid sorting method (title, author, read, unread):");
				...
				instructionLabel.setText("Showing books sorted by " + sortMethod);
				...
				outputArea.setText("");
				String fileName = JOptionPane.showInputDialog(GUIView.this,
						"Enter the name of the text file you want to add:");
				boolean found = model.addBooks(fileName);
				if (found) {
					instructionLabel.setText("The contents from " + fileName + " have been added to your library.");
				} else {
					instructionLabel.setText(fileName + " not found.");
				}
